...
const mongoURI =
  "mongodb+srv://aryan123:aryan123@cluster0.iodaduk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";

// Connect to MongoDB
mongoose
  .connect(mongoURI)
  .then(() =>
    console.log("MongoDB connected successfully to seekho-bharat database.")
  )
