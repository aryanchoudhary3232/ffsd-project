...
router.get(
  ...
  isAuthenticated,
  isInstructor,
  InstructorController.getCreateCourseForm
);
router.post(
  "/courses/new",
  isAuthenticated,
...
router.get(
  ...
  isAuthenticated,
  isInstructor,
  InstructorController.getCourseContentPage
);
...
router.get(
  ...
  isAuthenticated,
  isInstructor,
  InstructorController.getInstructorAnalytics
);
...
router.get(
  ...
  isAuthenticated,
  isInstructor,
  InstructorController.getCourseRatings
);
